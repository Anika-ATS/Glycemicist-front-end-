    ...
    const onSubmit = data => {
        ...
        createUser(data.email, data.password)
            .then(result => {
                ...
                const createdDoctor = result.doctor;
                ...
                updateUserProfile(createdUser,createdDoctor , data.name, data.photo).then(() => {
                    const newUser = {
                        name: data.name,
                        email: data.email,
                        image: data.photo,
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="card-body">
                        ...
                        <div >
                            ...
                            <Controller
                                ...
                                rules={{ required: true }}
                                render={({ field }) => (
                                    <select {...field} defaultValue={'DEFAULT'} onChange={(e) => { field.onChange(e); handleCategoryChange(e.target.value);  }} className='mt-2  w-full input input-bordered'>
                        ...
                        <div>
                            {watch('category') === 'doctor' && (
                                <div>
                                    <label className=" text-[#1d2939]">Current Designation:</label>
                                    <Controller
                                        name="Designation"
                                        control={control}
                                    ...
                                    />
                                    {errors.Designation && 
                                        <span  className="text-red-600">Please enter your form designation.
                                        </span>}
                                    ...
                                    />
                                    {errors.Degree && 
                                        <span  className="text-red-600">Please enter your form designation.</span>}
                                </div>
