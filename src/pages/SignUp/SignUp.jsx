    ...
    return (
        ...
        <div className="hero-content flex-col lg:flex-row-reverse">
            <div className="text-center lg:text-left">
                <figure className="px-5 pt-5"> <img src={SignUp1} alt="" className="rounded-xl" />
                </figure>
            ...
            <div className="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
                <form   onSubmit={handleSubmit(onSubmit)} className="card-body">
                    ...
                    <div className="form-control mt-6">
                        <input  className="btn btn-white text-cyan-500 outline outline-cyan-500 "  type='submit'  value='Sign In' />
                            {/* <button className="btn btn-primary">Sign In</button> */}
                    </div>
                    <div>
                    <h1 className="ps-5 text-xl font-bold text-cyan-500">You have an account? <Link className='link link:hover text-cyan-500' to='/login'>Login</Link></h1>
                    </div>
                </form>
            </div>
        </div>
