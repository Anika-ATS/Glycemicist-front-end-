...
const Services = () => {
    return (
        <div className="hero-content flex-col lg:flex-row-reverse  bg-base-300">
                    ...
                    <img src='' className="max-w-sm rounded-lg shadow-2xl hover:scale-75 hover:rotate-45" />
                    
                    <img src='' alt="" className="max-w-sm rounded-lg shadow-2xl hover:scale-75 hover:rotate-45" />
