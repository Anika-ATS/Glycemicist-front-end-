          ...
          <ul className="menu p-4 w-80 h-full    text-base-content bg-[#163750]">
              ...
              <>
                <li>
                  <NavLink
                    ...
                    className="text-xl font-normal  text-[#8ccce8] my-5"
                  >
                    <GiOpenBook className="text-2xl text-[#64D9B9]" />
                    All Users
                  </NavLink>
                </li>
                <li>
                  ...
                  <NavLink
                    ...
                    //   [#7bd0f4]
                    className="text-xl font-semibold text-[#64D9B9] my-5"
                  >
                    <BsBookmarkCheckFill className="text-2xl text-slate-200" />
                    Enrolled Classes
                  </NavLink>
                </li>
                <li>
                  ...
                  >
                    <BsCurrencyExchange className="text-xl text-orange-200" />
                    Payment History
                  </NavLink>{" "}
                </li>
              </>
            ...
            <li>
              <NavLink
                ...
                className="text-xl font-semibold text-[#7bd0f4] my-5"
              >
                <FaHome className="text-xl text-orange-200" />
                Home
              </NavLink>
            </li>
          </ul>
